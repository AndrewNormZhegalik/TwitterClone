...
class TweetHeader: UICollectionReusableView {
    ...
    private lazy var statsView: UIView = {
        ...
        divider2.anchor(top: view.bottomAnchor, left: view.leftAnchor, right: view.rightAnchor, paddingLeft: 8, height: 1.0)
    ...
    override init(frame: CGRect) {
        ...
        statsView.anchor(top: dateLabel.topAnchor, left: leftAnchor, right: rightAnchor, paddingTop: 20, height: 40)
